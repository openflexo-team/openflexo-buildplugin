...
class OpenFlexoBuildConfig implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        project.openflexo.utilsVersion = "1.5.0.1" + extension
        project.openflexo.connieVersion = "1.5.0.1" + extension
        project.openflexo.pamelaVersion = "1.5.0.1" + extension

        project.openflexo.ginaVersion = "2.2.0.1" + extension
        project.openflexo.dianaVersion = "1.5.0.1" + extension

        project.openflexo.openflexoVersion = "2.0.1" + extension
    }
}
